...
document.querySelector('.bs-error-icon').addEventListener("click", function () {
    Swal.fire({
        ...
        footer: 'assets/js/pages/ac-alert.js<a href>Why do I have this issue?</a>'
    })
});
document.querySelector('.bs-long-content').addEventListener("click", function () {
    Swal.fire({
        imageUrl: '../../../https/placeholderpics/svg/300x1500_7143509',
        imageHeight: 1500,
...
document.querySelector('.bs-cust-anim').addEventListener("click", function () {
    Swal.fire({
        title: 'Custom animation with Animate_4587621.css',
        showClass: {
...
document.querySelector('.bs-cust-img').addEventListener("click", function () {
    Swal.fire({
        ...
        imageUrl: '../../../https/fastlypicsumphotos/id/321/400/200_7798804.jpg',
        imageWidth: 400,
        imageHeight: 200,
...
document.querySelector('.bs-cust-full').addEventListener("click", function () {
    Swal.fire({
        ...
        backdrop: `
                rgba(0,0,123,0.4)
                url("../assets/images/profile/bg-2_jpg.html")
                left top
                no-repeat
              `
    })
...
document.querySelector('.bs-rtl-lang').addEventListener("click", function () {
    Swal.fire({
        title: 'ÙÙ ØªØ±ÙØ¯ Ø§ÙØ§Ø³ØªÙØ±Ø§Ø±Ø',
        icon: 'question',
        iconHtml: 'Ø',
...
document.querySelector('.bs-text-input').addEventListener("click", function () {
    (async () => {
        const ipAPI = '../../../https/2555906.json'
